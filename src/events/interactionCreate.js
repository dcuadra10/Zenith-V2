                ...
                try {
                    ...
                    if (seller1User) {
                        ...
                        const taxEmbed = new EmbedBuilder()
                            ...
                            .setDescription(`A transaction in which you participated has been completed. In accordance with server regulations, a **${taxRatePct}% tax** is due on all resources sold.\n\n⚠️ **Action Required:** Please send the required tax resources to **the kingdom bank**, and send a Direct Message with screenshot evidence to <@1211770249200795734>. They will verify and update your pending taxes.`)
                            .addFields(
